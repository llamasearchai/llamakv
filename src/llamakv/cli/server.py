...
from llamakv.persistence import MemoryBackend, FileBackend, SQLiteBackend
...
def parse_args():
    ...
    storage_type.add_argument(
        "--file",
        metavar="PATH",
        help="Use file-based storage (JSON file)"
    )
    
    storage_type.add_argument(
        "--sqlite",
        metavar="PATH",
        help="Use SQLite-based storage"
    )
