...
from llamakv.persistence import MemoryBackend, FileBackend
...
def client_example(server_ports):
    ...
    try:
        ...
        logger.info(f"After delete - distributed:2 exists remotely: {remote_value is not None}")
